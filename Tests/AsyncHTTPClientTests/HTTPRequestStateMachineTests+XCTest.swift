...
extension HTTPRequestStateMachineTests {
    static var allTests: [(String, (HTTPRequestStateMachineTests) -> () throws -> Void)] {
        return [
            ...
            ("testResponseReadingWithBackpressureEndOfResponseSetsCaughtReadEventFree", testResponseReadingWithBackpressureEndOfResponseSetsCaughtReadEventFree),
            ...
            ("testReadTimeoutLeadsToFailureWithEverythingAfterBeingIgnore", testReadTimeoutLeadsToFailureWithEverythingAfterBeingIgnore),
